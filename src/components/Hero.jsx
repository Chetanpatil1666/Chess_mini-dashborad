...
const Hero = () => {
  ...
  <button className="hero-button" onClick={() => window.dispatchEvent(new CustomEvent('start-music'))}>Enter the Realm</button>
  </Tilt>
</div>
...
<div className="section3" ref={section3Ref}>
  ...
  <Tilt
    ...
    <button onClick={() => window.dispatchEvent(new CustomEvent('start-music'))}>Play Your First Game</button>
    </Tilt>
  </div>
</div>
